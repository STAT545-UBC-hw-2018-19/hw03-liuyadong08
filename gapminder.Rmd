...
The following chunks will put the table and plot side by side, but only when the output is a html_document file. Please look at the gapminder.html to see how it works. I was inspired by this [webpage](https://stackoverflow.com/questions/31753897/2-column-section-in-r-markdown). 
